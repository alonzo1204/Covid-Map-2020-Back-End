...
(async function registerTest() {
  ...
  try {
    ...
    await driver.findElement(By.name('lastname')).sendKeys('admin3');
    await driver.findElement(By.name('username')).sendKeys('admin3');
    await driver.findElement(By.name('email')).sendKeys('admin3@gmail.com');
